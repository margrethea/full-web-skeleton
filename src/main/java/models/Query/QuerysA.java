...
public class QuerysA {
    ...
    public static String alleResultat(String query){
        query = ("select roklubb.klubbnavn, bruker.fornavn, bruker.etternavn, a_resultat.år, a_resultat.periode, a_resultat.60w, a_resultat.bevegelighet, a_resultat.5000w, a_resultat.5000t, a_resultat.2000w, a_resultat.2000t, a_resultat.ligg_ro_kg, a_resultat.ligg_ro_p, a_resultat.sargeant, a_resultat.toppscore FROM ro.bruker, ro.a_resultat WHERE bruker.roklubb_id = roklubb.roklubb_id AND a_resultat.bruker_id=bruker.bruker_id AND bruker.klasse_id = 2 ORDER BY a_resultat.år;");
        return query;
    }
