...
public class QuerysC {
    ...
    public static String alleResultatC(String query) {
        query = ("select roklubb.klubbnavn, bruker.fornavn, bruker.etternavn, c_resultat.år, c_resultat.periode, c_resultat.60w, c_resultat.bevegelighet, c_resultat.3000m, c_resultat.kroppshev, c_resultat.sargeant FROM ro.bruker, ro.roklubb, ro.c_resultat WHERE c_resultat.bruker_id=bruker.bruker_id AND bruker.klasse_id = 4 ORDER BY c_resultat.år;");
        return query;
    }
