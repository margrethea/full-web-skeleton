...
public class QuerysS {
    ...
    public static String søkFornavn(String query){
        query = ("select roklubb.klubbnavn, bruker.fornavn, bruker.etternavn, s_resultat.år, s_resultat.periode, s_resultat.60w, s_resultat.bevegelighet, s_resultat.5000w, s_resultat.5000t, s_resultat.2000w, s_resultat.2000t, s_resultat.ligg_ro_kg, s_resultat.ligg_ro_p, s_resultat.knebøy_kg, s_resultat.knebøy_p, s_resultat.toppscore FROM ro.bruker, ro.s_resultat, ro.roklubb WHERE s_resultat.bruker_id = bruker.bruker_id AND bruker.roklubb_id = roklubb.roklubb_id  AND bruker.fornavn = ? ORDER BY s_resultat.år;");
        return query;
    }
    ...
    public static String søkAlleParam(String query){
        query = ("select roklubb.klubbnavn, bruker.fornavn, bruker.etternavn, s_resultat.år, s_resultat.periode, s_resultat.60w, s_resultat.bevegelighet, s_resultat.5000w, s_resultat.5000t, s_resultat.2000w, s_resultat.2000t, s_resultat.ligg_ro_kg, s_resultat.ligg_ro_p, s_resultat.knebøy_kg, s_resultat.knebøy_p, s_resultat.toppscore FROM ro.bruker, ro.s_resultat, ro.roklubb WHERE s_resultat.bruker_id = bruker.bruker_id AND bruker.roklubb_id = roklubb.roklubb_id AND bruker.fornavn = ? AND bruker.etternavn = ? AND s_resultat.periode = ? AND bruker.kjønn = ? AND s_resultat.år = ? ORDER BY s_resultat.år;");
        return query;
    }
    ...
    public static String søkEtternavn(String query){
        query = ("select roklubb.klubbnavn, bruker.fornavn, bruker.etternavn, s_resultat.år, s_resultat.periode, s_resultat.60w, s_resultat.bevegelighet, s_resultat.5000w, s_resultat.5000t, s_resultat.2000w, s_resultat.2000t, s_resultat.ligg_ro_kg, s_resultat.ligg_ro_p, s_resultat.knebøy_kg, s_resultat.knebøy_p, s_resultat.toppscore FROM ro.bruker, ro.s_resultat, ro.roklubb WHERE s_resultat.bruker_id = bruker.bruker_id AND bruker.roklubb_id = roklubb.roklubb_id AND bruker.etternavn = ? ORDER BY s_resultat.år;");
        return query;
    }
    ...
    public static String søkPeriode(String query){
        query = ("select roklubb.klubbnavn, bruker.fornavn, bruker.etternavn, s_resultat.år, s_resultat.periode, s_resultat.60w, s_resultat.bevegelighet, s_resultat.5000w, s_resultat.5000t, s_resultat.2000w, s_resultat.2000t, s_resultat.ligg_ro_kg, s_resultat.ligg_ro_p, s_resultat.knebøy_kg, s_resultat.knebøy_p, s_resultat.toppscore FROM ro.bruker, ro.s_resultat, ro.roklubb WHERE s_resultat.bruker_id = bruker.bruker_id AND bruker.roklubb_id = roklubb.roklubb_id AND s_resultat.periode = ? ORDER BY s_resultat.år;");
        return query;
    }
    ...
    public static String søkKjønn(String query){
        query = ("select roklubb.klubbnavn, bruker.fornavn, bruker.etternavn, s_resultat.år, s_resultat.periode, s_resultat.60w, s_resultat.bevegelighet, s_resultat.5000w, s_resultat.5000t, s_resultat.2000w, s_resultat.2000t, s_resultat.ligg_ro_kg, s_resultat.ligg_ro_p, s_resultat.knebøy_kg, s_resultat.knebøy_p, s_resultat.toppscore FROM ro.bruker, ro.s_resultat, ro.roklubb WHERE s_resultat.bruker_id = bruker.bruker_id AND bruker.roklubb_id = roklubb.roklubb_id AND bruker.kjønn = ? ORDER BY s_resultat.år;");
        return query;
    }
    ...
    public static String søkÅr(String query){
        query = ("select roklubb.klubbnavn, bruker.fornavn, bruker.etternavn, s_resultat.år, s_resultat.periode, s_resultat.60w, s_resultat.bevegelighet, s_resultat.5000w, s_resultat.5000t, s_resultat.2000w, s_resultat.2000t, s_resultat.ligg_ro_kg, s_resultat.ligg_ro_p, s_resultat.knebøy_kg, s_resultat.knebøy_p, s_resultat.toppscore FROM ro.bruker, ro.s_resultat, ro.roklubb WHERE s_resultat.bruker_id = bruker.bruker_id AND bruker.roklubb_id = roklubb.roklubb_id AND s_resultat.år = ? ORDER BY s_resultat.år;");
        return query;
    }
    ...
    public static String søkFornavnEtternavn(String query){
        query = ("select roklubb.klubbnavn, bruker.fornavn, bruker.etternavn, s_resultat.år, s_resultat.periode, s_resultat.60w, s_resultat.bevegelighet, s_resultat.5000w, s_resultat.5000t, s_resultat.2000w, s_resultat.2000t, s_resultat.ligg_ro_kg, s_resultat.ligg_ro_p, s_resultat.knebøy_kg, s_resultat.knebøy_p, s_resultat.toppscore FROM ro.bruker, ro.s_resultat, ro.roklubb WHERE s_resultat.bruker_id = bruker.bruker_id AND bruker.roklubb_id = roklubb.roklubb_id  AND bruker.fornavn = ? AND bruker.etternavn = ? ORDER BY s_resultat.år;");
        return query;
    }
    ...
    public static String søkEtternavnKjønn(String query){
        query = ("select roklubb.klubbnavn, bruker.fornavn, bruker.etternavn, s_resultat.år, s_resultat.periode, s_resultat.60w, s_resultat.bevegelighet, s_resultat.5000w, s_resultat.5000t, s_resultat.2000w, s_resultat.2000t, s_resultat.ligg_ro_kg, s_resultat.ligg_ro_p, s_resultat.knebøy_kg, s_resultat.knebøy_p, s_resultat.toppscore FROM ro.bruker, ro.s_resultat, ro.roklubb WHERE s_resultat.bruker_id = bruker.bruker_id AND bruker.roklubb_id = roklubb.roklubb_id AND bruker.kjønn = ? AND bruker.etternavn = ? ORDER BY s_resultat.år;");
        return query;
    }
