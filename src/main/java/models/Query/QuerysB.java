...
public class QuerysB {
    ...
    public static String alleResultatB(String query){
        query = ("select roklubb.klubbnavn, bruker.fornavn, bruker.etternavn, b_resultat.år, b_resultat.periode, b_resultat.60w, b_resultat.bevegelighet, b_resultat.3000m, b_resultat.2000w, b_resultat.2000t, b_resultat.kroppshev, b_resultat.sargeant, b_resultat.toppscore FROM ro.bruker, ro.roklubb, ro.b_resultat WHERE b_resultat.bruker_id=bruker.bruker_id AND bruker.klasse_id = 3 ORDER BY b_resultat.år;");
        return query;
    }
    ...
    public static String søkÅrB(String query){
        query = ("select roklubb.klubbnavn, bruker.fornavn, bruker.etternavn, b_resultat.år, b_resultat.periode, b_resultat.60w, b_resultat.bevegelighet, b_resultat.3000m, b_resultat.2000w, b_resultat.2000t, b_resultat.kroppshev, b_resultat.sargeant, b_resultat.toppscore, bruker.klasse_id FROM ro.bruker, ro.roklubb, ro.b_resultat WHERE b_resultat.bruker_id = bruker.bruker_id AND b_resultat.år = ? ORDER BY b_resultat.år;");
        return query;
    }
    ...
    public static String søkKlubb(String query){
        query = ("select roklubb.klubbnavn, bruker.fornavn, bruker.etternavn, b_resultat.år, b_resultat.periode, b_resultat.60w, b_resultat.bevegelighet, b_resultat.3000m, b_resultat.2000w, b_resultat.2000t, b_resultat.kroppshev, b_resultat.sargeant, b_resultat.toppscore, bruker.klasse_id FROM ro.bruker, ro.roklubb, ro.b_resultat WHERE bruker.roklubb_id = roklubb.roklubb_id AND bruker.bruker_id = b_resultat.bruker_id AND roklubb.klubbnavn = ? ORDER BY b_resultat.år;");
        return query;
    }
